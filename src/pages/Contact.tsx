...
export function Contact() {
    return (
        <>
            <Banner title="Come see us, give us a call, or fill out the form below and we will get back to you."  style="" image="/assets/images/ContactBanner.png" />
            <div className="w-full h-full flex flex-col justify-center items-center">
                <div className="flex items-center justify-center m-10 w-full h-full">
                    <div className=" flex flex-col-reverse relative xl:w-5/6 w-full mx- xl:mx-0 h-full ">
                        ...
                        <div className="flex flex-col w-6/12 justify-center items-center z-50 pt-10 lg:pt-0">
                            ...
                            <div className="flex flex-col mt-10">
                                <div className="flex lg:flex-row flex-col  gap-x-10  ">
                                    <div className="flex flex-col lg:items-start items-center justify-center">
                                        ...
                                        <p className="text-white z-50 text-lg lg:text-start text-center" >138 Cummins Ferry Versailles, KY </p>
                                    </div>
                                    <div className="flex flex-col lg:items-start items-center justify-center">
                                        ...
                                        <p className="text-white z-50 text-lg lg:text-start text-center whitespace-nowrap">Email: testemail@gmail.com</p>
                                    </div>
                                </div>
