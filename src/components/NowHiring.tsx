  ...
  return (
    <>
      <div className=" md:max-w-7xl w-full flex justify-center px-8 pt-10">
        ...
        <div className="flex flex-col justify-center items-center">
          <div className="flex flex-col ">
            <p className="text-center font-bold text-primary-green text-3xl font-helvetica">
              Now Hiring
            </p>
          </div>
          <div className="bg-gray-100 flex flex-col justify-center items-center p-2">
            <h1 className="text-red-800 font-semibold text-2xl pb-2">
            ...
            <ul className="list-disc">
              <li className="text-lg">Loading/Unloading trees</li>
            ...
            <div className="py-4">
              <span className="font-semibold ">Please Note:</span> We are a
      ...
      <div className="bg-primary-green text-white font-medium font-raleway p-2">
        <div className="text-center font-bold text-white md:text-2xl text-xl flex flex-col md:flex-row justify-center items-center">
          Please reach out to
