...
export function Banner({
  ...
  return (
    ...
    >
      ...
      />
      <div
        className={`absolute inset-0 bg-black opacity-55 h-full ${style}`}
      ></div>
      <div
        ...
        {location.pathname === "/" ? (
          <>
            <div className="z-40 flex flex-col justify-center items-center ">
              <div className="lg:flex items-center md:pb-10 hidden">
                <img
                ...
                <img
                  ...
                  className="w-24 h-24 mt-8 justify-items-center rounded-xl"
                />
              </div>
